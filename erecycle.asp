...
pgcontent = ""
	...
	rs.Open "select pagename,content from cms_content where pagename='Electronics recycling' and status = 'P'",con,3,3
...
if pgcontent = "" then 
		...
		if instr(GetPath,"Electronics recycling") >0 then
		Response.Redirect "http://www.r3ewaste.com/Electronics-recycling"
	end if	
...
<head>
	...
	<title>Old Electronics Recycler | Electronics Recycling Services in US: R3Ewaste</title>
	<meta name="description" content="R3Ewaste provides electronics recycling services to a wide range of clients. We offer Electronics’ collection and logistics support, guaranteed data destruction.">
	<meta name="title" content="Old Electronics Recycler | Electronics Recycling Services in US: R3Ewaste">
