...
pgcontent = ""
	...
	rs.Open "select pagename,content from cms_content where pagename='Laptop refurbishment' and status = 'P'",con,3,3
...
if pgcontent = "" then 
	...
	if instr(GetPath,"Computer recycling") >0 then
		Response.Redirect "http://www.r3ewaste.com/Laptop-refurbishment"
	end if	
...
<head>
	...
	<title>Leading Laptop Refurbishment Services Company | R3Ewaste</title>
	<meta name="description" content="Looking for Refurbished Laptops and notebooks?  R3Ewaste provides refurbished products at affordable pricing. Contact us today for our refurb products.">
	<meta name="title" content="Leading Laptop Refurbishment Services Company | R3Ewaste">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <h2 class="aboutpage-title">Refurbished Laptops</h2>
